...
## Model API & Testing
A deployment of the linear regression model is available as a publicly routable service.
The API endpoint that returns predictions given input values is available at:
**[https://linear-regression-model-7a17.onrender.com](https://linear-regression-model-7a17.onrender.com)**

To assess the model and test the prediction endpoints, you can use the **Swagger UI** testing interface available here:
**[Swagger UI (Docs)](https://linear-regression-model-7a17.onrender.com/docs)**
...
1. Ensure you have [Flutter](https://docs.flutter.dev/get-started/install) installed and your development environment is set up.
